...
.method public constructor <init>(Landroid/app/Activity;)V
    ...
    iput-object p1, p0, Lcom/alipay/sdk/util/f;->b:Landroid/app/Activity;
...
.method private a(Ljava/lang/String;Landroid/content/Intent;)Ljava/lang/String;
    ...
    :cond_1
    iput-boolean v3, p0, Lcom/alipay/sdk/util/f;->e:Z

    iget-object v0, p0, Lcom/alipay/sdk/util/f;->c:Lcom/alipay/android/app/IAlixPay;

    if-nez v0, :cond_2

    iget-object v0, p0, Lcom/alipay/sdk/util/f;->b:Landroid/app/Activity;

    invoke-virtual {v0}, Landroid/app/Activity;->getApplicationContext()Landroid/content/Context;

    move-result-object v0

    iget-object v2, p0, Lcom/alipay/sdk/util/f;->g:Landroid/content/ServiceConnection;
    ...
    :cond_2
    :try_start_0
    iget-object v2, p0, Lcom/alipay/sdk/util/f;->d:Ljava/lang/Object;
    ...
    :try_start_3
    iget-object v2, p0, Lcom/alipay/sdk/util/f;->b:Landroid/app/Activity;
    ...
    :goto_1
    iput-boolean v6, p0, Lcom/alipay/sdk/util/f;->e:Z

    iget-boolean v1, p0, Lcom/alipay/sdk/util/f;->f:Z

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/alipay/sdk/util/f;->b:Landroid/app/Activity;

    invoke-virtual {v1, v6}, Landroid/app/Activity;->setRequestedOrientation(I)V

    iput-boolean v6, p0, Lcom/alipay/sdk/util/f;->f:Z
    ...
    iput-object v1, p0, Lcom/alipay/sdk/util/f;->c:Lcom/alipay/android/app/IAlixPay;
    ...
    iget-object v2, p0, Lcom/alipay/sdk/util/f;->h:Lcom/alipay/android/app/IRemoteServiceCallback;
    ...
    :try_start_7
    iget-object v2, p0, Lcom/alipay/sdk/util/f;->c:Lcom/alipay/android/app/IAlixPay;
    ...
    iput-object v2, p0, Lcom/alipay/sdk/util/f;->c:Lcom/alipay/android/app/IAlixPay;
    :try_end_7
...
.method static synthetic b(Lcom/alipay/sdk/util/f;)Landroid/app/Activity;
    .locals 1
