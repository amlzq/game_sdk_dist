...
.method public printStackTrace(Ljava/io/PrintWriter;)V
    ...
    .prologue
    .line 311
    iget-object v6, p0, Lorg/apache/commons/lang/exception/NestableDelegate;->nestable:Ljava/lang/Throwable;
    ...
    .line 314
    instance-of v7, v6, Lorg/apache/commons/lang/exception/Nestable;
    ...
    .line 315
    check-cast v7, Lorg/apache/commons/lang/exception/Nestable;

    invoke-interface {v7, p1}, Lorg/apache/commons/lang/exception/Nestable;->printPartialStackTrace(Ljava/io/PrintWriter;)V
    ...
    .line 317
    :cond_0
    invoke-virtual {v6, p1}, Ljava/lang/Throwable;->printStackTrace(Ljava/io/PrintWriter;)V
    ...
    .line 324
    .local v5, "stacks":Ljava/util/List;
    :goto_1
    if-nez v6, :cond_5
    ...
    .line 332
    .local v3, "separatorLine":Ljava/lang/String;
    sget-boolean v7, Lorg/apache/commons/lang/exception/NestableDelegate;->topDown:Z
    ...
    .line 338
    :cond_2
    sget-boolean v7, Lorg/apache/commons/lang/exception/NestableDelegate;->trimStackFrames:Z

    if-eqz v7, :cond_3

    .line 339
    invoke-virtual {p0, v5}, Lorg/apache/commons/lang/exception/NestableDelegate;->trimStackFrames(Ljava/util/List;)V
    ...
    .line 325
    .end local v3    # "separatorLine":Ljava/lang/String;
    :cond_5
    invoke-virtual {p0, v6}, Lorg/apache/commons/lang/exception/NestableDelegate;->getStackFrames(Ljava/lang/Throwable;)[Ljava/lang/String;
    ...
    .line 327
    invoke-static {v6}, Lorg/apache/commons/lang/exception/ExceptionUtils;->getCause(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    ...
    .restart local v3    # "separatorLine":Ljava/lang/String;
    :cond_6
    :try_start_1
